...
db = databank.fromCSV("data/forecast_tunisia-2021Q4.csv");
...
[h.il_spread_tnd, h.il_spread_gap] = hpf( ...
    ...
    , "lambda", 5000 ...
    , "change", Series(endHist, 0) ...
    , "level", Series(qq(2021,2), real(m.il_spread)) ...
);
...
databank.toCSV(h, "csv/initial-conditions-2021Q4.csv", "decimals", 16);

save mat/dates-2021Q4.mat startHist endHist startFcast endFcast
